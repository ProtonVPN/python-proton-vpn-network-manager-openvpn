...
@pytest.mark.parametrize("openvpn_protocol", [OpenVPNUDP, OpenVPNTCP])
def test_networkmanager(openvpn_protocol, test_environment, vpn_server, openvpn_username, openvpn_password):
